...
public class Lua_UnityEngine_Light : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_lightmappingMode(IntPtr l) {
		try {
			UnityEngine.Light self=(UnityEngine.Light)checkSelf(l);
			pushValue(l,true);
			pushEnum(l,(int)self.lightmappingMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_lightmappingMode(IntPtr l) {
		try {
			UnityEngine.Light self=(UnityEngine.Light)checkSelf(l);
			UnityEngine.LightmappingMode v;
			checkEnum(l,2,out v);
			self.lightmappingMode=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"lightmappingMode",get_lightmappingMode,set_lightmappingMode,true);
